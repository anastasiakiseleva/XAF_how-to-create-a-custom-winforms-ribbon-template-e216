...
Namespace DevExpress.ExpressApp.Win.CustomTemplates
    Partial Public Class MainForm
        ...
        Protected Overrides Function GetFormStateNode() As IModelFormState
            For Each modelFormState As IModelFormState In ModelTemplate.FormStates
                If modelFormState.Id = "Default" Then
        ...
        Public ReadOnly Property ToolBar() As Bar
            ...
            End Get
        End Property
        Public ReadOnly Property StatusBarMainForm() As Bar
            Get
                Return _statusBar
            End Get
        End Property
