namespace DevExpress.ExpressApp.Win.CustomTemplates {
	partial class MainForm {
		...
		private void InitializeComponent() {
            ...
            this.StatusBar});
			this.mainBarManager.Controller = this.barAndDockingController1;
			...
			this.mainBarManager.DockManager = this.dockManager1;
			...
			this.cViewsNavigation.Visibility = DevExpress.XtraBars.BarItemVisibility.Never;
			// 
			// cDiagnostic
			// 
