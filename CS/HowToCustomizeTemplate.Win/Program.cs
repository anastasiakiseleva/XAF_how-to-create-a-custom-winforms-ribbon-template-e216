...
namespace HowToCustomizeTemplate.Win {
    static class Program {
        ...
        static void Main() {
            ...
            HowToCustomizeTemplateWindowsFormsApplication winApplication = new HowToCustomizeTemplateWindowsFormsApplication();
            winApplication.CreateCustomTemplate += new EventHandler<CreateCustomTemplateEventArgs>(application_CreateCustomTemplate);
